...
/**
 * Bandeau d'invitation à installer l'application PlaceDuCoin (PWA). Il n'apparaît que pour les
 * visiteurs arrivés via le QR code de l'affiche vitrine (`?app=1` dans l'URL) et qui n'ont pas
 * déjà installé l'application : un client qui scanne l'affiche voit la fiche du commerce ET la
 * proposition de garder PlaceDuCoin sur son écran d'accueil.
 */
export function InstallAppBanner() {
  ...
  return (
    <div
      role="region"
      aria-label="Installer l'application PlaceDuCoin"
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="text-sm font-bold">Installez PlaceDuCoin</p>
        {installEvent ? (
